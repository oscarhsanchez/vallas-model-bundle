...
/**
 * @ORM\Entity(repositoryClass="Vallas\ModelBundle\Repository\MetadataDoubleValueRepository")
 * @ORM\Table(name="metadata_double_value")
 * @ORM\HasLifecycleCallbacks
 */
class MetadataDoubleValue extends GenericEntity
{

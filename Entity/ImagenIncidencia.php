...
/**
 * @ORM\Entity(repositoryClass="Vallas\ModelBundle\Repository\ImagenIncidenciaRepository")
 * @ORM\Table(name="imagenes_incidencias")
 * @ORM\HasLifecycleCallbacks
 */
class ImagenIncidencia extends GenericEntity
{
     ...
     * @var OrdenTrabajo
     *
     * @ORM\ManyToOne(targetEntity="Vallas\ModelBundle\Entity\Incidencia", inversedBy="imagenes")

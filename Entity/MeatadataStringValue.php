...
/**
 * @ORM\Entity(repositoryClass="Vallas\ModelBundle\Repository\MetadataStringValueRepository")
 * @ORM\Table(name="metadata_string_value")
 * @ORM\HasLifecycleCallbacks
 */
class MetadataStringValue extends GenericEntity
{
